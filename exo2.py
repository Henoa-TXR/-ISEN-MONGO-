...
def lille():
    ...
    exo2_collection.insert_many(lilleTab)  
...
def paris():
    ...
    #Ajout des données dans la BDD
    exo2_collection.insert_many(parisTab)
...
def lyon():
    ...
    # Ajout des données dans la BDD
    exo2_collection.insert_many(lyonTab)
...
def rennes():
    ...
    #Ajout des données dans la BDD
    exo2_collection.insert_many(rennesTab)
...
exo2_collection.drop()
exo2_collection.create_index([("location",GEOSPHERE)])
